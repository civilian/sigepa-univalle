    ...
    public static class AuxiliarControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Auxiliar) {
                ...
                return getStringKey(o.getCodauxiliar());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+AuxiliarController.class.getName());
            }
        }

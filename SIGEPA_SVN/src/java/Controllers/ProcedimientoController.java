...
import Facades.ProcedimientoFacade;
...
public class ProcedimientoController {
    ...
    @EJB private Facades.ProcedimientoFacade ejbFacade;
    ...
    public static class ProcedimientoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Procedimiento) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+ProcedimientoController.class.getName());
            }
        }
